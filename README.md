...
*Hello World* is a simple web application that has api which returns a random greetings designed using RoR + React.
...
<!-- ## 🚀 Live Demo <a name="live-demo"></a>
 ...
 - [Live Demo Link](https://i-budget.onrender.com/)

 - [Presentation Video](https://youtu.be/6M1RJ3Pi0_U)
...
```sh
  cd my-folder
  git clone https://github.com/mohametalmeari/full-stack-hello-world.git
```
...
Feel free to check the [issues page](https://github.com/mohametalmeari/full-stack-hello-world/issues).
